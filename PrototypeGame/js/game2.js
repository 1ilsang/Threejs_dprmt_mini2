...
var opst_left_px4 = 0;
var opst_left_px5 = 0;
var opst_left_core = 0; //고점수
var opst_move_d = 5;//장애물 비행기 이동거리
var opst_move_core = 0.1;//장애물 비행기 이동거리
...
function game_stage_j(v) {
    ...
    if (game_stage == 1) {
        ...
        opst_move_f1();
        opst_move_coremonny();
        setTimeout(opst_move_coremonny, 500);
...
function opst_init() {
    ...
    opst_top_core = br_height * Math.random() - 400;
    ...
    document.styleSheets[0].rules[18].style.marginTop = opst_top_core + 'px';
    ...
    document.styleSheets[0].rules[18].style.marginLeft = '0px';
    ...
    document.styleSheets[0].rules[18].style.left = br_width + 'px';
    ...
    document.styleSheets[0].rules[18].style.display = 'none';
}
...
function opst_move_coremonny() {
    document.styleSheets[0].rules[18].style.display = 'block';
    opst_left_core = opst_left_core - opst_move_core;
    document.styleSheets[0].rules[18].style.marginLeft = opst_left_core + 'px';
    opst_movex_core = setTimeout(opst_move_coremonny, 1);
    if (opst_left_core <= -br_width && happyCount) {
        happyCount--;
        clearTimeout(opst_movex_core);
        opst_left_core = 0;
        document.styleSheets[0].rules[18].style.marginLeft = opst_left_core + 'px';
    ...
    if (opst_left_core <= left_px - br_width + 150 && opst_left_core >= left_px - br_width - 50 && opst_top_core <= top_px + 53 && opst_top_core >= top_px - 53) {
        game_count = game_count + 6;//게임 레벨 카운터 증가
        clearTimeout(opst_movex_core);
        opst_left_core = 0;
        document.styleSheets[0].rules[18].style.marginLeft = opst_left_core + 'px';
        opst_top_core = br_height * Math.random() - 400;
